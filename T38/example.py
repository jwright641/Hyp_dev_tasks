...
#  Using the 'en_core_web_sm' language model does returns a warning as there are no word vectors within that model.
#  Instead the .similarity methods is based on the tagger, parser and NER.
